                ...
                <div class="ind-custom-menu">
                    ...
                    <div class="col col-right">
                        ...
                        if ( is_user_logged_in() ) {
                           echo '<ul><li class="user-detail"><div class="user"><i class="fa fa-user" aria-hidden="true"></i><i class="fa fa-angle-down arrow-down" aria-hidden="true"></i><div class="drop"><ul><li><a href="<?php echo wp_logout_url( get_permalink() ); ?>"><i class="fa fa-power-off" aria-hidden="true"></i> Logout</a></li></ul></div></div></li></ul>';
                        }
                        else{
