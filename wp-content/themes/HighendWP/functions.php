 ...
 */
        ...
        function hb_register_required_plugins() {
            ...
            $plugins           = array(
                ...
                array(
                    ...
                    'force_activation' => false,
                    'force_deactivation' => false,
                    'external_url'       => 'https://downloads.wordpress.org/plugin/contact-form-7.4.7.zip'
                ),
                array(
    ...
    * Disabled in 3.3.4 because of img tag issue
    ...
    /* SET WP TITLE
    * Removed in 3.3.4 to prevent issues with SEO plugins
    ================================================== */
    /*add_filter('wp_title', 'hb_wp_title', 10, 2);
    if( !function_exists('hb_wp_title') ) {
        function hb_wp_title($title, $sep) {
            global $paged, $page;
                
            if ( hb_seo_plugin_installed() ) {
                // SEO plugin will take care of the title
            } else {             
                return $title;
            }
        }
