...
<div class="hb-notif-box custom-alerts non-eligible hidden"><div class="message-text"><p><i class="fa fa-check-circle" style="color: #fff;"></i> Wine Bottles in cart are not in multiples of 6 in order to opt for subscription, Wine bottles in cart have to be multiples of 6.</p></div></div>
